	...
	return (
		<div className="flex flex-col md:flex-row h-screen font-inter">
			<div className="md:w-1/2 flex flex-col justify-center items-center">
				...
				<h2 className="text-sm mb-4 mt-12 text-zinc-500 leading-5">Digite seu celular para acessar sua conta.</h2>
				<form className="w-full max-w-sm mt-4">
					<input
						type="email"
						id="email"
						name="email"
						className="appearance-none bg-zinc-50 rounded-full w-full h-12 py-2 px-5 text-gray-700 text-xs leading-tight focus:outline-none focus:shadow-outline"
						placeholder="E-mail"
					/>
			...
			<div className="w-1/2 h-screen">
				<img className="h-screen object-cover" src={guys_laptop} alt="guys_laptop" />
			</div>
		</div>
	);
};
